...
challengeController.addChallenge = (req, res) => __awaiter(this, void 0, void 0, function* () {
    try {
...
challengeController.getChallengeBySpot = (req, res) => __awaiter(this, void 0, void 0, function* () {
    try {
        console.log(req.params);
        const challenges = yield Challenge.find({ spotName: req.params.spotName });
        res.status(200);
        res.send(challenges);
    }
    catch (error) {
...
challengeController.toggleCompleted = (req, res) => __awaiter(this, void 0, void 0, function* () {
    try {
...
challengeController.getSpotByCompleted = (req, res) => __awaiter(this, void 0, void 0, function* () {
    try {
